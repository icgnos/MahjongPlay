package com.mahjongcraft.interaction
...
import com.mahjongcraft.ui.TurnTimerBar
import com.mahjongcraft.util.YakuNameChinese
...
class PaperGameBridge(
    ...
    val tableManager: com.mahjongcraft.table.MahjongTableManager,
    ...
    private fun startHudUpdates() {
        hudTaskId = Bukkit.getScheduler().scheduleSyncRepeatingTask(MahjongCraftPlugin.instance, { updateHud() }, 0L, 20L)
    }
